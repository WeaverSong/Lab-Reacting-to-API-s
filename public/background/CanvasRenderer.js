...
class CanvasRenderer
{
    ...
    */
    Size(Settings, i)
    {
        ...
        if (Settings.width !== this.canvas.width) {
            this.canvas.width = Settings.width;
            //Just for this case we do want to edit the styles width
            this.canvas.style.width = Settings.width + "px";
        }
        if (Settings.height !== this.canvas.height) {
            this.canvas.height = Settings.height;
            //Just for this case we do want to edit the styles height
            this.canvas.style.height = Settings.height + "px";
        };
